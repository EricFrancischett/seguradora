<!-- menu.php -->
	...
	if(!isset($_SESSION ['login'])){                              // Não houve login ainda
		...
		header('location: /seguradora/index.php');    // Vai para a página inicial
		exit();
    }
	?>
	<div class="w3-top"   > 
		...
		<div class="w3-bar w3-theme w3-large" style="z-index:-1">
			...
			<a class="w3-bar-item w3-button w3-hide-medium w3-hide-small w3-hover-light-gray w3-padding-16" href="veiListar.php" onclick="w3_show_nav('menuVeiculo')">Veículo</a>
		</div>
	</div>
	...
	<div class="w3-sidebar w3-bar-block w3-collapse w3-animate-left" style="z-index:3;width:270px" id="mySidebar" >
		<div class="w3-bar w3-hide-large w3-large">
			<a href="javascript:void(0)" onclick="w3_show_nav('menuVeiculo')"
			   class="w3-bar-item w3-button w3-theme w3-hover-light-gray w3-padding-16" style="width:50%">Veículos</a>

			   
		</div>
		<a href="javascript:void(0)" onclick="w3_close()" class="w3-button w3-right w3-xlarge w3-hide-large"
		   title="Close Menu">x</a>
		<div id="menuVeiculo" class="myMenu">
			<div class="w3-container">
				<h3>Menu Veículos</h3>
			</div>
			<a class="w3-bar-item w3-button" href="veiListar.php">Relação de Veículos</a>
			<a class="w3-bar-item w3-button" href="veiIncluir.php">Cadastro de Veículos</a>
